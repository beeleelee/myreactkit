...
var define;
!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?e(exports):"function"==typeof define&&define.amd?define(["exports"],e):e(t.mytoolkit={})}(this,function(t){"use strict";var i="undefined"!=typeof performance?function(){return performance.now()}:function(){return+new Date},r="undefined"!=typeof window?window.requestAnimationFrame||window.webkitRequestAnimationFrame:function(t){return setTimeout(t,1e3/60)},o={},n=0,s=!1,u=function t(){var e=Object.keys(o);if(0===e.length)s=!1;else{var n=i();e.forEach(function(t){o[t](n)}),r(t),s=!0}},a={add:function(t){var e="clock_".concat(n++);return o[e]=t,s||u(),e},remove:function(t){o[t]&&delete o[t]}};function c(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function h(t,e){for(var n=0;n<e.length;n++){var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}function f(t,e,n){return e&&h(t.prototype,e),n&&h(t,n),t}var e=function(){function e(t){c(this,e),this.startTime=0,this.currentTime=0,this.percent=0,this.setOptions(t),this.step=this.step.bind(this)}return f(e,[{key:"setOptions",value:function(){var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},e=t.duration,n=void 0===e?0:e;this.duration=n,this.options=Object.assign({},this.options,t)}},{key:"start",value:function(){return this.startTime=this.currentTime=i(),this.clockId=a.add(this.step),this}},{key:"pause",value:function(){a.remove(this.clockId),this.clockId=null}},{key:"stop",value:function(){a.remove(this.clockId),this.clockId=null,this.percent=0,this.options.onEnd&&this.options.onEnd(this)}},{key:"step",value:function(t){var e=(this.currentTime=t)-this.startTime,n=!1;0<this.duration-e?this.percent=e/this.duration:(this.percent=1,n=!0),this.options.onStep&&this.options.onStep(this,this.percent),n&&this.stop()}}]),e}(),l=function(){function e(t){c(this,e),this.step=this.step.bind(this),this.setOptions(t)}return f(e,[{key:"setOptions",value:function(){var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},e=t.velocity,n=t.resistance,i=void 0===n?.001:n;return e&&(this.velocity=e),this.resistance=i,this.options=Object.assign({},this.options,t),this}},{key:"start",value:function(){return this.prevTime=this.currentTime=i(),this.sign=0<this.velocity?1:-1,this.prevV=Math.abs(this.velocity),this.clockId=a.add(this.step),this}},{key:"stop",value:function(){return a.remove(this.clockId),this.clockId=null,this.options.onEnd&&this.options.onEnd(),this}},{key:"step",value:function(t){var e=(this.currentTime=t)-this.prevTime,n=this.prevV;if(n<=0)this.stop();else{var i=n*e-this.resistance*Math.pow(e,2)/2;this.options.onStep&&this.options.onStep(this.sign*i),this.prevTime=this.currentTime,this.prevV=this.prevV-this.resistance*e}}}]),e}();function p(t){var e=Object.prototype.toString.call(t);return"Number"===(e=e.slice(8,-1))&&isNaN(t)?"NaN":e}function d(t,e){if(t=parseInt(t),e=parseInt(e),"Number"!==p(t))throw new TypeError("randInt needs number from its parameter!");return e||(e=t,t=0),Math.floor(Math.random()*(e-t)+t)}var m=null,v=function(t,e,n){if(!t||!t.style)throw new Error("missing HTML node element for setStyle!");var i;i=e,(e=function(){if(null!==m)return m;if("undefined"==typeof document)throw new Error("missing document!");var t=document.createElement("div"),e=Object.keys(t.style).filter(function(t){return/^webkit(transform|transition)$/i.test(t)});return m=e.reduce(function(t,e){return t[e.replace(/^webkit(\w)/,function(t,e){return e.toLowerCase()})]=e,t},{}),t=null,m}()[i]||i)&&n&&(t.style[e]=n)};t.currentTime=i,t.tick=a,t.Tween=e,t.Deceleration=l,t.typeOf=p,t.addComma=function(t){var e=parseFloat(t);if("Number"!==p(e))throw new TypeError("addComma need number form its parameter!");var n=e<0?"-":"",i=parseInt(Math.abs(e))+"",r=(e+"").replace(/\-?\d*/,""),o=3<i.length?i.length%3:0;return n+(o?i.substr(0,o)+",":"")+i.substr(o).replace(/(\d{3})(?=\d)/g,"$1,")+r},t.padZero=function(t){var e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:2,n=parseFloat(t);if("Number"!==p(n))throw new TypeError("fillZero needs number for its first parameter!");var i=e-(n=String(n)).length;return i<=0?n:Array.from({length:i}).map(function(t){return 0}).join("")+n},t.IDFactory=function(){var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:1;return function(){return t++}},t.randInt=d,t.randStr=function(){var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:6,e=1<arguments.length?arguments[1]:void 0,n="0123456789abcdefghijklmnopqrstuvwxyzsABCDEFGHIJKLMNOPQRSTUVWXYZ",i=Array.from({length:t});"String"===p(e)&&(n=e);var r=n.length;return i.map(function(){return n[d(r)]}).join("")},t.setStyle=function(e,n,t){"Object"===p(n)?Object.keys(n).map(function(t){v(e,t,n[t])}):v(e,n,t)},Object.defineProperty(t,"__esModule",{value:!0})});
