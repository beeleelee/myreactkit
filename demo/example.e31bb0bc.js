...
var define;
!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?e(exports):"function"==typeof define&&define.amd?define(["exports"],e):e(t.mytoolkit={})}(this,function(t){"use strict";var i="undefined"!=typeof performance?function(){return performance.now()}:function(){return+new Date},r="undefined"!=typeof window?window.requestAnimationFrame||window.webkitRequestAnimationFrame:function(t){return setTimeout(t,1e3/60)},o={},n=0,s=!1,a=function t(){var e=Object.keys(o);if(0===e.length)s=!1;else{var n=i();e.forEach(function(t){o[t](n)}),r(t),s=!0}},u={add:function(t){var e="clock_".concat(n++);return o[e]=t,s||a(),e},remove:function(t){o[t]&&delete o[t]}};function c(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function h(t,e){for(var n=0;n<e.length;n++){var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}function f(t,e,n){return e&&h(t.prototype,e),n&&h(t,n),t}var e=function(){function e(t){c(this,e),this.startTime=0,this.currentTime=0,this.percent=0,this.setOptions(t),this.step=this.step.bind(this)}return f(e,[{key:"setOptions",value:function(){var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},e=t.duration,n=void 0===e?0:e;this.duration=n,this.options=Object.assign({},this.options,t)}},{key:"start",value:function(){return this.startTime=this.currentTime=i(),this.clockId=u.add(this.step),this}},{key:"pause",value:function(){u.remove(this.clockId),this.clockId=null}},{key:"stop",value:function(){u.remove(this.clockId),this.clockId=null,this.percent=0,this.options.onEnd&&this.options.onEnd(this)}},{key:"step",value:function(t){var e=(this.currentTime=t)-this.startTime,n=!1;0<this.duration-e?this.percent=e/this.duration:(this.percent=1,n=!0),this.options.onStep&&this.options.onStep(this,this.percent),n&&this.stop()}}]),e}(),p=function(){function e(t){c(this,e),this.step=this.step.bind(this),this.setOptions(t)}return f(e,[{key:"setOptions",value:function(){var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},e=t.velocity,n=t.resistance,i=void 0===n?.001:n;return e&&(this.velocity=e),this.resistance=i,this.options=Object.assign({},this.options,t),this}},{key:"start",value:function(){return this.prevTime=this.currentTime=i(),this.sign=0<this.velocity?1:-1,this.prevV=Math.abs(this.velocity),this.clockId=u.add(this.step),this}},{key:"stop",value:function(){return u.remove(this.clockId),this.clockId=null,this.options.onEnd&&this.options.onEnd(),this}},{key:"step",value:function(t){var e=(this.currentTime=t)-this.prevTime,n=this.prevV;if(n<=0)this.stop();else{var i=n*e-this.resistance*Math.pow(e,2)/2;this.options.onStep&&this.options.onStep(this.sign*i),this.prevTime=this.currentTime,this.prevV=this.prevV-this.resistance*e}}}]),e}();function l(t){var e=Object.prototype.toString.call(t);return"Number"===(e=e.slice(8,-1))&&isNaN(t)?"NaN":e}function d(t){var e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:2,n=parseFloat(t);if("Number"!==l(n))throw new TypeError("fillZero needs number for its first parameter!");var i=e-(n=String(n)).length;return i<=0?n:Array.from({length:i}).map(function(t){return 0}).join("")+n}function m(t,e){if(t=parseInt(t),e=parseInt(e),"Number"!==l(t))throw new TypeError("randInt needs number from its parameter!");return e||(e=t,t=0),Math.floor(Math.random()*(e-t)+t)}var v=null,y=function(t,e,n){if(!t||!t.style)throw new Error("missing HTML node element for setStyle!");var i;i=e,"Undefined"!==l(e=function(){if(null!==v)return v;if("undefined"==typeof document)throw new Error("missing document!");var t=Array.from(getComputedStyle(document.body)),e=Object.keys(t).filter(function(t){return/^webkit(transform|transition)$/i.test(t)});return v=e.reduce(function(t,e){return t[e.replace(/^webkit(\w)/,function(t,e){return e.toLowerCase()})]=e,t},{})}()[i]||i)&&"Undefined"!==l(n)&&(t.style[e]=n)};function b(){return Math.round(i()/1e3)}t.currentTime=i,t.tick=u,t.Tween=e,t.Deceleration=p,t.typeOf=l,t.addComma=function(t){var e=parseFloat(t);if("Number"!==l(e))throw new TypeError("addComma need number form its parameter!");var n=e<0?"-":"",i=parseInt(Math.abs(e))+"",r=(e+"").replace(/\-?\d*/,""),o=3<i.length?i.length%3:0;return n+(o?i.substr(0,o)+",":"")+i.substr(o).replace(/(\d{3})(?=\d)/g,"$1,")+r},t.padZero=d,t.IDFactory=function(){var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:1;return function(){return t++}},t.randInt=m,t.randStr=function(){var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:6,e=1<arguments.length?arguments[1]:void 0,n="0123456789abcdefghijklmnopqrstuvwxyzsABCDEFGHIJKLMNOPQRSTUVWXYZ",i=Array.from({length:t});"String"===l(e)&&(n=e);var r=n.length;return i.map(function(){return n[m(r)]}).join("")},t.setStyle=function(e,n,t){"Object"===l(n)?Object.keys(n).map(function(t){y(e,t,n[t])}):y(e,n,t)},t.deepCopy=function n(e){var i;switch(l(e)){case"Object":i={},Object.keys(e).forEach(function(t){i[t]=n(e[t])});break;case"Array":i=[],e.forEach(function(t,e){i[e]=n(t)});break;default:i=e}return i},t.trim=function(t){return(t+"").replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"")},t.timestamp=b,t.stampToDS=function(){var t,e,n,i,r,o=0<arguments.length&&void 0!==arguments[0]?arguments[0]:b(),s=new Date;return 10===(o+"").length&&(o*=1e3),s.setTime(o),t=s.getFullYear(),e=s.getMonth()+1,n=s.getDate(),i=s.getHours(),r=s.getSeconds(),"".concat(t,"-").concat(d(e),"-").concat(d(n)," ").concat(d(i),":").concat(d(r))},Object.defineProperty(t,"__esModule",{value:!0})});
...
function (_React$Component) {
  ...
  _createClass(Carousel, [{
    ...
    value: function doTouchStart(e) {
      ...
      this.startTime = (0, _mytoolkit.currentTime)();
    }
  }, {
    key: "doTouchMove",
    ...
    value: function doTouchEnd(e) {
      ...
      if (this.isTransition) return;
      e.stopPropagation();
      this.timegap = (0, _mytoolkit.currentTime)() - this.startTime;
