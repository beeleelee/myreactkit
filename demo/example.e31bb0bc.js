...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"../src/styles/page.js":[function(require,module,exports) {
"use strict";
...
},{}],"../src/Page.js":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  function Page() {
    ...
    _this.scrollEndTimeHandle = null;
    _this.doScrollEnd = _this.doScrollEnd.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }

  _createClass(Page, [{
    key: "doScrollEnd",
    value: function doScrollEnd() {
      var _this$props = this.props,
          _this$props$onScrollE = _this$props.onScrollEnd,
          onScrollEnd = _this$props$onScrollE === void 0 ? func : _this$props$onScrollE,
          _this$props$reachEndT = _this$props.reachEndThreshold,
          reachEndThreshold = _this$props$reachEndT === void 0 ? 50 : _this$props$reachEndT,
          _this$props$onReachEn = _this$props.onReachEnd,
          onReachEnd = _this$props$onReachEn === void 0 ? func : _this$props$onReachEn,
          _this$props$onReachTo = _this$props.onReachTop,
          onReachTop = _this$props$onReachTo === void 0 ? func : _this$props$onReachTo;
      ...
      var _this$content$getBoun = this.content.getBoundingClientRect(),
          contentHeight = _this$content$getBoun.height;
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          _this$props2$onScroll = _this$props2.onScroll,
          _onScroll = _this$props2$onScroll === void 0 ? func : _this$props2$onScroll,
          _this$props2$onScroll2 = _this$props2.onScrollEnd,
          onScrollEnd = _this$props2$onScroll2 === void 0 ? func : _this$props2$onScroll2,
          _this$props2$onReachE = _this$props2.onReachEnd,
          onReachEnd = _this$props2$onReachE === void 0 ? func : _this$props2$onReachE,
          _this$props2$onReachT = _this$props2.onReachTop,
          onReachTop = _this$props2$onReachT === void 0 ? func : _this$props2$onReachT,
          _this$props2$reachEnd = _this$props2.reachEndThreshold,
          reachEndThreshold = _this$props2$reachEnd === void 0 ? 50 : _this$props2$reachEnd,
          style = _this$props2.style,
          children = _this$props2.children,
          props = _objectWithoutProperties(_this$props2, ["onScroll", "onScrollEnd", "onReachEnd", "onReachTop", "reachEndThreshold", "style", "children"]);
      ...
      return _react.default.createElement("div", _extends({}, props, {
        ...
        onScroll: function onScroll(e) {
          _onScroll(_this2.container.scrollTop);

          if (_this2.scrollEndTimeHandle) {
            clearTimeout(_this2.scrollEndTimeHandle);
            _this2.scrollEndTimeHandle = null;
          }

          _this2.scrollEndTimeHandle = setTimeout(_this2.doScrollEnd, 100);
        },
        style: _objectSpread({}, _page.pageStyle, style)
...
},{"react":"../node_modules/react/index.js","./styles/page":"../src/styles/page.js"}],"../src/images/loadingGIF.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/mytoolkit/dist/mytoolkit.umd.js":[function(require,module,exports) {
var define;
!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?e(exports):"function"==typeof define&&define.amd?define(["exports"],e):e(t.mytoolkit={})}(this,function(t){"use strict";var e=function(){return+new Date},r="undefined"!=typeof performance?function(){return performance.now()}:function(){return+new Date},i="undefined"!=typeof window?window.requestAnimationFrame||window.webkitRequestAnimationFrame:function(t){return setTimeout(t,1e3/60)},o={},n=0,s=!1,a=function t(){var e=Object.keys(o);if(0===e.length)s=!1;else{var n=r();e.forEach(function(t){o[t](n)}),i(t),s=!0}},u={add:function(t){var e="clock_".concat(n++);return o[e]=t,s||a(),e},remove:function(t){o[t]&&delete o[t]}};function c(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function h(t,e){for(var n=0;n<e.length;n++){var r=e[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}function p(t,e,n){return e&&h(t.prototype,e),n&&h(t,n),t}var f=function(){function e(t){c(this,e),this.startTime=0,this.currentTime=0,this.percent=0,this.setOptions(t),this.step=this.step.bind(this)}return p(e,[{key:"setOptions",value:function(){var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},e=t.duration,n=void 0===e?0:e;this.duration=n,this.options=Object.assign({},this.options,t)}},{key:"start",value:function(){return this.startTime=this.currentTime=r(),this.clockId=u.add(this.step),this}},{key:"pause",value:function(){u.remove(this.clockId),this.clockId=null}},{key:"stop",value:function(){u.remove(this.clockId),this.clockId=null,this.percent=0,this.options.onEnd&&this.options.onEnd(this)}},{key:"step",value:function(t){var e=(this.currentTime=t)-this.startTime,n=!1;0<this.duration-e?this.percent=e/this.duration:(this.percent=1,n=!0),this.options.onStep&&this.options.onStep(this,this.percent),n&&this.stop()}}]),e}(),d=function(){function e(t){c(this,e),this.step=this.step.bind(this),this.setOptions(t)}return p(e,[{key:"setOptions",value:function(){var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},e=t.velocity,n=t.resistance,r=void 0===n?.001:n;return e&&(this.velocity=e),this.resistance=r,this.options=Object.assign({},this.options,t),this}},{key:"start",value:function(){return this.prevTime=this.currentTime=r(),this.sign=0<this.velocity?1:-1,this.prevV=Math.abs(this.velocity),this.clockId=u.add(this.step),this}},{key:"stop",value:function(){return u.remove(this.clockId),this.clockId=null,this.options.onEnd&&this.options.onEnd(),this}},{key:"step",value:function(t){var e=(this.currentTime=t)-this.prevTime,n=this.prevV;if(n<=0)this.stop();else{var r=n*e-this.resistance*Math.pow(e,2)/2;this.options.onStep&&this.options.onStep(this.sign*r),this.prevTime=this.currentTime,this.prevV=this.prevV-this.resistance*e}}}]),e}();function l(t){var e=Object.prototype.toString.call(t);return"Number"===(e=e.slice(8,-1))&&isNaN(t)?"NaN":e}var m=String.prototype.padStart,y=String.prototype.padEnd;function v(t,e,n){return g("start",t,e,n)}function g(t,e,n,r){var i="start"==t?m:y;if("Function"===l(i))return i.call(e,n,r);var o=(e=String(e)).length;if(0<=o-n)return e;var s=n-o,a=(r=String(r)).length;return("start"===t?"":e)+Array.from({length:s}).map(function(t,e){return r[e%a]}).join("")+("start"===t?e:"")}function b(t){return v(t,1<arguments.length&&void 0!==arguments[1]?arguments[1]:2,0)}function w(t,e){if(t=parseInt(t),e=parseInt(e),"Number"!==l(t))throw new TypeError("randInt needs number from its parameter!");return e||(e=t,t=0),Math.floor(Math.random()*(e-t)+t)}var k=null,T=function(t,e,n){if(!t||!t.style)throw new Error("missing HTML node element for setStyle!");var r;r=e,"Undefined"!==l(e=function(){if(null!==k)return k;if("undefined"==typeof document)throw new Error("missing document!");var t=Array.from(getComputedStyle(document.body)),e=Object.keys(t).filter(function(t){return/^webkit(transform|transition)$/i.test(t)});return k=e.reduce(function(t,e){return t[e.replace(/^webkit(\w)/,function(t,e){return e.toLowerCase()})]=e,t},{})}()[r]||r)&&"Undefined"!==l(n)&&(t.style[e]=n)};function S(){return Math.round(e()/1e3)}var E=["yyyy-mm-dd hh:mm:ss","yyyy-mm-dd hh:mm","yyyy-mm-dd","hh:mm:ss","hh:mm"];t.currentTime=e,t.performanceNow=r,t.tick=u,t.Tween=f,t.Deceleration=d,t.typeOf=l,t.addComma=function(t){var e=parseFloat(t);if("Number"!==l(e))throw new TypeError("addComma need number form its parameter!");var n=e<0?"-":"",r=parseInt(Math.abs(e))+"",i=(e+"").replace(/-?\d*/,""),o=3<r.length?r.length%3:0;return n+(o?r.substr(0,o)+",":"")+r.substr(o).replace(/(\d{3})(?=\d)/g,"$1,")+i},t.padZero=b,t.IDFactory=function(){var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:1;return function(){return t++}},t.randInt=w,t.randStr=function(){var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:6,e=1<arguments.length?arguments[1]:void 0,n="0123456789abcdefghijklmnopqrstuvwxyzsABCDEFGHIJKLMNOPQRSTUVWXYZ",r=Array.from({length:t});"String"===l(e)&&(n=e);var i=n.length;return r.map(function(){return n[w(i)]}).join("")},t.setStyle=function(e,n,t){"Object"===l(n)?Object.keys(n).map(function(t){T(e,t,n[t])}):T(e,n,t)},t.deepCopy=function n(e){var r;switch(l(e)){case"Object":r={},Object.keys(e).forEach(function(t){r[t]=n(e[t])});break;case"Array":r=[],e.forEach(function(t,e){r[e]=n(t)});break;default:r=e}return r},t.trim=function(t){return(t+"").replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"")},t.timestamp=S,t.stampToDS=function(){var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:S(),e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"yyyy-mm-dd hh:mm";if(!E.includes(String(e).toLowerCase()))throw new TypeError("stampToDS - invalid format! suported formats: \n".concat(E.join("\n")));var n,r,i,o,s,a,u=t,c=new Date,h=e;return 10===(u+"").length&&(u*=1e3),c.setTime(u),n=c.getFullYear(),r=c.getMonth()+1,i=c.getDate(),o=c.getHours(),s=c.getMinutes(),a=c.getSeconds(),h=(h=(h=(h=(h=(h=h.replace(/yyyy/i,n)).replace(/mm(?=-)/i,b(r))).replace(/dd/i,b(i))).replace(/hh/i,b(o))).replace(/:mm/i,":".concat(b(s)))).replace(/ss/i,b(a))},t.padStart=v,t.padEnd=function(t,e,n){return g("start",t,e,n)},Object.defineProperty(t,"__esModule",{value:!0})});

},{}],"../src/styles/lazy.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.lazyStyle = void 0;
var lazyStyle = {
...
exports.lazyStyle = lazyStyle;
},{}],"../src/LazyPic.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.LazyPic = void 0;

var _react = _interopRequireDefault(require("react"));

var _loadingGIF = _interopRequireDefault(require("./images/loadingGIF"));

var _mytoolkit = require("mytoolkit");

var _lazy = require("./styles/lazy");
...
var unShowList = [];
var genID = (0, _mytoolkit.IDFactory)(1);

var LazyPic =
/*#__PURE__*/
function (_React$Component) {
  _inherits(LazyPic, _React$Component);
  ...
  function LazyPic() {
    ...
    _classCallCheck(this, LazyPic);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(LazyPic)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(LazyPic, [{
    key: "checkShouldLoad",
    value: function checkShouldLoad(saveToList) {
    ...
    value: function componentWillUnmount() {
      var id = this.id;
      unShowList = unShowList.filter(function (item) {
        return item.id !== id;
      });
    }
  }, {
    ...
    value: function render() {
      ...
      var ImgLoading = this.props.loadingurl || _loadingGIF.default;
      ...
      return _react.default.createElement("div", _extends({
        ref: function ref(node) {
          return _this3.element = node;
        }
      }, this.props, {
        style: _objectSpread({}, _lazy.lazyStyle, {
          backgroundImage: "url(".concat(ImgLoading, ")")
        })
      }));
    }
  }]);
...
exports.LazyPic = LazyPic;

LazyPic.checkLazy = function () {
  var newList = unShowList.map(function (item) {
  ...
  unShowList = newList.filter(function (item) {
    return item !== null;
  });
};

var _default = LazyPic;
exports.default = _default;
},{"react":"../node_modules/react/index.js","./images/loadingGIF":"../src/images/loadingGIF.js","mytoolkit":"../node_modules/mytoolkit/dist/mytoolkit.umd.js","./styles/lazy":"../src/styles/lazy.js"}],"../src/styles/carousel.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.dotStyle = exports.dotWrapStyle = exports.slideItemStyle = exports.slidesStyle = exports.slideContainerStyle = void 0;
var slideContainerStyle = {
  position: 'relative',
  overflow: 'hidden',
  width: '100%'
};
exports.slideContainerStyle = slideContainerStyle;
var slidesStyle = {
  position: 'absolute',
  top: 0,
  left: 0,
...
exports.slidesStyle = slidesStyle;
var slideItemStyle = {
  flexShrink: 0,
  width: '100%'
};
exports.slideItemStyle = slideItemStyle;
var dotWrapStyle = {
  display: 'flex',
  flexDirection: 'row',
...
exports.dotWrapStyle = dotWrapStyle;
var dotStyle = {
  width: 6,
  height: 6,
  borderRadius: 3,
...
function (_React$Component) {
  ...
  function Carousel(props) {
    ...
    var propsToBind = ['setDimension', 'doTouchEnd', 'doTouchMove', 'doTouchStart', 'setOffsetX', 'nextSlide', 'prevSlide'];
    propsToBind.forEach(function (name) {
      _this[name] = _this[name].bind(_assertThisInitialized(_assertThisInitialized(_this)));
    });
    _this.autoplayTimeHandle = null;
    _this.offsetX = 0;
  ...
  _createClass(Carousel, [{
    ...
    value: function setOffsetX(offsetX) {
      ...
      (0, _mytoolkit.setStyle)(this.slides, 'transform', "translate3d(".concat(offsetX, "px, 0, 0)"));
    }
  }, {
    key: "tweenSlide",
    value: function tweenSlide(duration, startX, endX, nextIndex) {
      var _this2 = this;

      this.tween = new _mytoolkit.Tween({
        duration: duration,
        onStep: function onStep(t, percent) {
          var offsetX = startX + (endX - startX) * percent;

          _this2.setOffsetX(offsetX);
        },
        onEnd: function onEnd(e) {
          ...
          _this2.setState({
            ...
            _this2.isTransition = false;
            _this2.tween = null;
            _this2.autoplaying = false;
            var afterChange = _this2.props.afterChange;
            _this2.prevIndex !== nextIndex && afterChange && afterChange(nextIndex);
          });
        }
      }).start();
    }
    ...
    value: function prevSlide() {
      ...
      var childList = _react.default.Children.toArray(this.props.children);

      if (childList.length < 2) return;
      this.autoplaying = true;
      this.beforeScroll(function () {
        _this3.isTransition = true;

        _this3.tweenSlide(tweenDuration, -1 * _this3.slideWidth, 0, _this3.firstIndex);
      });
    }
  }, {
    key: "nextSlide",
    value: function nextSlide() {
      ...
      this.autoplaying = true;
      this.beforeScroll(function () {
        _this4.isTransition = true;

        _this4.tweenSlide(tweenDuration, -1 * _this4.slideWidth, -2 * _this4.slideWidth, _this4.lastIndex);
      });
    }
  }, {
    key: "autoplay",
    ...
    key: "beforeScroll",
    value: function beforeScroll(func) {
      var _this5 = this;
      ...
      this.setState({
        ...
        _this5.setOffsetX((_this5.shouldRenderFirst ? -1 : 0) * _this5.slideWidth);
    ...
    value: function doTouchStart(e) {
      ...
      this.startTime = (0, _mytoolkit.performanceNow)();
    }
  }, {
    key: "doTouchMove",
    ...
    value: function doTouchEnd(e) {
      ...
      if (this.isTransition) return;
      e.stopPropagation();
      this.timegap = (0, _mytoolkit.performanceNow)() - this.startTime;
    ...
    value: function setDimension() {
      var _this$slides$getBound = this.slides.getBoundingClientRect(),
          height = _this$slides$getBound.height;

      var _this$slideContainer$ = this.slideContainer.getBoundingClientRect(),
          width = _this$slideContainer$.width;
    ...
    key: "preLoadImage",
    value: function preLoadImage(list) {
    ...
    key: "renderSlide",
    value: function renderSlide(item) {
      if (this.slideWidth) {
        _carousel.slideItemStyle.width = this.slideWidth;
      }

      return _react.default.createElement("div", {
        style: _objectSpread({}, _carousel.slideItemStyle),
    ...
    value: function renderSlides() {
      ...
      var list = _react.default.Children.toArray(this.props.children);

      var _this$state = this.state,
          isScroll = _this$state.isScroll,
          curIndex = _this$state.curIndex;
      var firstIndex = curIndex - 1;
      ...
      return _react.default.createElement("div", {
        ref: function ref(node) {
          return _this7.slides = node;
        },
        className: "slides",
        style: _objectSpread({}, _carousel.slidesStyle)
      }, this.preLoadImage(list), isScroll && this.shouldRenderFirst ? this.renderSlide(list[this.firstIndex]) : null, this.renderSlide(list[curIndex]), isScroll && this.shouldRenderLast ? this.renderSlide(list[this.lastIndex]) : null);
    }
  }, {
    key: "renderDots",
    value: function renderDots() {
      ...
      return _react.default.createElement("div", {
        style: _objectSpread({}, _carousel.dotWrapStyle)
      }, list.length > 1 && list.map(function (item, key) {
        return _react.default.createElement("div", {
          style: _objectSpread({}, _carousel.dotStyle, {
            backgroundColor: "".concat(key === _this8.state.curIndex ? '#666666' : '#d8d8d8')
          }),
          key: key
        });
      }));
    ...
    value: function render() {
      ...
      if (this.props.style && this.props.style.height) {
        _carousel.slideContainerStyle.height = this.props.style.height;
      }

      return _react.default.createElement("div", {
        ref: function ref(node) {
          return _this9.slideContainer = node;
        },
        className: "slide-container",
        style: _objectSpread({}, _carousel.slideContainerStyle)
      }, this.renderSlides(), this.renderDots());
    }
  }]);
...
},{"react":"../node_modules/react/index.js","mytoolkit":"../node_modules/mytoolkit/dist/mytoolkit.umd.js","./styles/carousel":"../src/styles/carousel.js"}],"../src/styles/pageRefresh.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.scrollBarStyle = exports.refreshWrapStyle = exports.scrollContentStyle = exports.scrollViewWrapperStyle = void 0;
var scrollViewWrapperStyle = {
  overflow: 'hidden',
  position: 'fixed',
  left: 0,
  right: 0,
...
exports.scrollViewWrapperStyle = scrollViewWrapperStyle;
...
exports.refreshWrapStyle = refreshWrapStyle;
var scrollBarStyle = {
  position: 'absolute',
  width: 2,
  background: '#aeaeae',
...
},{}],"../src/PageRefresh.js":[function(require,module,exports) {
"use strict";
...
var _pageRefresh = require("./styles/pageRefresh");
...
var refreshHeight = 40;
var refreshTimeSpan = 1500;
var reachEndTreshhold = 50;

var PageRefresh =
/*#__PURE__*/
function (_React$Component) {
  _inherits(PageRefresh, _React$Component);
  ...
  function PageRefresh() {
    ...
    _classCallCheck(this, PageRefresh);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(PageRefresh)).call.apply(_getPrototypeOf2, [this].concat(args)));
    var propsToBind = ['doTouchStart', 'doTouchMove', 'doTouchEnd', 'doDeceleration', 'doScrollEnd', 'doRefreshEnd'];
    propsToBind.forEach(function (name) {
      _this[name] = _this[name].bind(_assertThisInitialized(_assertThisInitialized(_this)));
    });
    _this.scrollTop = 0;
  ...
  _createClass(PageRefresh, [{
    ...
    value: function doTouchStart(e) {
      ...
      this.startY = this.currentY = pageY;
      this.touchArray = [{
        time: (0, _mytoolkit.performanceNow)(),
        y: pageY
      }];
      (0, _mytoolkit.setStyle)(this.scrollBar, 'opacity', 1);
    ...
    value: function doTouchMove(e) {
      ...
      if (this.refreshing) return;
      var pageY = e.touches[0].pageY;
      var delta = pageY - this.currentY;
      var bMargin = this.containerHeight + this.scrollTop - this.contentHeight;
      var resistance = 1;
    ...
    value: function doTouchEnd(e) {
      ...
      var bMargin = this.containerHeight + this.scrollTop - this.contentHeight; // do deceleration 

      var l = this.touchArray.length;
      var lastTouch = this.touchArray[l - 1];
      var fromTouch = this.touchArray[l - 2];
      ...
      var v = (lastTouch.y - fromTouch.y) / (lastTouch.time - fromTouch.time); // no deceleration when out of margin
    ...
    key: "doRefreshEnd",
    value: function doRefreshEnd() {
      var _this2 = this;

      var startY = this.scrollTop;
      var endY = 0;
      this.tweenAni = new _mytoolkit.Tween({
        duration: 150,
        onStep: function onStep(t, percent) {
          _this2.scrollTop = startY + (endY - startY) * percent;

          _this2.setScrollTop();
        },
        onEnd: function onEnd(e) {
          _this2.scrollTop = endY;

          _this2.setScrollTop();

          _this2.refreshing = false;
          _this2.shouldRefresh = false;
        }
      });
      this.tweenAni.start();
    }
    ...
    value: function doScrollEnd() {
      ...
      if (this.scrollTop < 0 || bMargin > 0) {
        ...
        this.tweenAni = new _mytoolkit.Tween({
          duration: 300,
          onStep: function onStep(t, percent) {
            _this3.scrollTop = startY + (endY - startY) * percent;

            _this3.setScrollTop();
          },
          onEnd: function onEnd(e) {
            _this3.scrollTop = endY;

            _this3.setScrollTop();

            if (_this3.shouldRefresh) {
              _this3.props.onRefresh && _this3.props.onRefresh();
              setTimeout(_this3.doRefreshEnd, refreshTimeSpan);
            }
          }
        });
        this.tweenAni.start();
      ...
      (0, _mytoolkit.setStyle)(this.scrollBar, 'opacity', 0);
    }
  }, {
    key: "doDeceleration",
    value: function doDeceleration(movement) {
    ...
    value: function setScrollTop() {
      var t = "translate3d(0, ".concat(-1 * this.scrollTop, "px, 0)");
      (0, _mytoolkit.setStyle)(this.scrollContent, 'transform', t);
      var scrollBarTop = this.scrollTop / this.contentHeight * this.containerHeight;
      (0, _mytoolkit.setStyle)(this.scrollBar, 'top', "".concat(scrollBarTop, "px"));
    }
  }, {
    ...
    value: function getContentHeight() {
      var _this$scrollContent$g = this.scrollContent.getBoundingClientRect(),
          height = _this$scrollContent$g.height;
    ...
    value: function calculateContentHeight() {
      ...
      if (this.contentHeight > this.containerHeight) {
        var scrollBarHeight = this.containerHeight * (this.containerHeight / this.contentHeight);
        (0, _mytoolkit.setStyle)(this.scrollBar, 'height', "".concat(scrollBarHeight, "px"));
      } else {
        (0, _mytoolkit.setStyle)(this.scrollBar, 'height', 0);
      }
    }
  }, {
    key: "componentDidMount",
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        style: _objectSpread({}, _pageRefresh.scrollViewWrapperStyle, this.props.style),
        ref: function ref(node) {
          return _this4.container = node;
        },
        className: "scroll-view-wrapper"
      }, _react.default.createElement("div", {
        style: _objectSpread({}, _pageRefresh.scrollContentStyle),
        ref: function ref(node) {
          return _this4.scrollContent = node;
        },
        className: "scroll-content"
      }, _react.default.createElement("div", {
        style: _objectSpread({}, _pageRefresh.refreshWrapStyle)
      }, _react.default.createElement("img", {
        src: _loadingGIF.default,
        style: {
          width: 20
        }
      })), this.props.children), _react.default.createElement("div", {
        ref: function ref(node) {
          return _this4.scrollBar = node;
        },
        style: _objectSpread({}, _pageRefresh.scrollBarStyle),
...
Object.defineProperty(exports, "LazyPic", {
  enumerable: true,
  get: function () {
    return _LazyPic.default;
  }
});
...
Object.defineProperty(exports, "PageRefresh", {
  enumerable: true,
  get: function () {
...
var _LazyPic = _interopRequireDefault(require("./LazyPic"));
...
var App = function App() {
  return _react.default.createElement(_src.PageRefresh, {
    ...
    className: "App-Title"
  }, "Hello Parcel x React"), Array.from({
    length: 15
  }).map(function (i, key) {
    return _react.default.createElement("div", {
      key: key
